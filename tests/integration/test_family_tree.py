...
class TestFamilyTree(TestCase):
    ...
    def test_add_child(self):
        ...
        self.assertEqual(self.ftree.add_child("Zim", "Male", "Mother"), constants.PERSON_NOT_FOUND)
        self.assertEqual(self.ftree.add_child("Zim", "Male", "Father"), constants.CHILD_ADDITION_FAILED)
        ...
        self.assertEqual(self.ftree.add_child("Zim", "Male", "Mother"), constants.CHILD_ADDITION_SUCCEEDED)
        self.assertEqual(self.ftree.add_child("Zim", "Male", "Mother"), constants.CHILD_ADDITION_FAILED)
        self.assertEqual(self.ftree.family_tree.get("Zim", None) is not None, True)

    def test_add_spouse(self):
        self.assertEqual(self.ftree.add_spouse("Wife", "Female", "Zim"), constants.SPOUSE_ADDITION_FAILED)
        dummy_member = Member(1, "DummyMember", "Male")
        self.ftree.family_tree['DummyMember'] = dummy_member
        self.assertEqual(self.ftree.add_spouse("Wife", "Female", "Zim"), constants.PERSON_NOT_FOUND)
        ...
        self.assertEqual(self.ftree.add_spouse("Wife", "Female", "FakeMember"), constants.SPOUSE_ADDITION_FAILED)
        self.assertEqual(self.ftree.add_spouse("Wife", "Female", "AlreadyMarriedMember"), constants.SPOUSE_ADDITION_FAILED)
        self.assertEqual(self.ftree.add_spouse("Wife", "Female", "Zim"), constants.SPOUSE_ADDITION_SUCCEEDED)
        self.assertEqual(self.ftree.add_spouse("Wife", "Female", "Zim"), constants.SPOUSE_ADDITION_FAILED)
    ...
    def test_get_relationship(self):
        ...
        self.assertEqual(self.ftree.get_relationship("Zim", "daughter"), constants.NONE)
